<div id="header">
        ...
        <div class="container">
            ...
            <div class="pull-right auto-width-right">
                <ul class="top-details menu-beta l-inline">
                    ...
                    <li><a href="logout"><ion-icon name="log-out-outline"></ion-icon>{{Session('users')->name}}</a></li>
                    @else
    ...
    <div class="cart">
        ...
        <div class="beta-dropdown cart-body">
            @foreach($product_cart as $id => $product)
            <div class="cart-item" id="cart-item{{$product['item']['id']}}">
                <a class="cart-item-delete" href="del-cart/{{$id}}" value="{{$id}}" soluong="{{$product['qty']}}"><i class="fa fa-times"></i></a>
                <div class="media">
